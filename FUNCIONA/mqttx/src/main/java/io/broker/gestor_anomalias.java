...
public class gestor_anomalias {
    ...
    public static void main(String[] args) {
        ...
        // Anomalia casoEstudio8 = new Anomalia(1, 101, 10, "Vulnerabilidad CVE-107", "Nivel de riesgo muy alto, dispositivo prohibido");
        // anomaList.add(casoEstudio8);

        // // Caso 9: Dispositivo con nivel de riesgo medio, quedará en cuarentena
        // Anomalia casoEstudio9 = new Anomalia(2, 102, 5, "Vulnerabilidad CVE-108", "Nivel de riesgo medio, dispositivo en cuarentena");
        // anomaList.add(casoEstudio9);

        // // Caso 10: Dispositivo con nivel de riesgo bajo, quedará incluido en la red
        // Anomalia casoEstudio10 = new Anomalia(3, 103, 1, "Vulnerabilidad CVE-109", "Nivel de riesgo bajo, dispositivo permitido");
