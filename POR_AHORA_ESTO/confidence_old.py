...
def on_message(client, userdata, msg):
    ...
    if topic == "iot/anomalia/to_confianza":
        ...
        #json_data = '{"thingID":3,"anomaliaID":3,"probabilidad":1,"gravedad":1,"detectabilidad":1,"amenaza":"Vulnerabilidad CVE-103","descripcion":"Dispositivo nuevo que será incluido"}'
        json_data = message
